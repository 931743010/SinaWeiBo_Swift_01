...
class YYStatusNormalCell: YYStatusCell {
    ...
    override func prepareUI() {
        ...
        // 原创微博的配图约束
        let constraint = pictureView.ff_AlignVertical(type: ff_AlignType.BottomLeft, referView: contentLabel, size: CGSize(width: UIScreen.width() - 2 * 8, height: 0), offset: CGPoint(x: 0, y: 8))
